...
import 'package:cocreator/pages/screens/hakim/constants/colors.dart';
import 'package:cocreator/pages/screens/hakim/controllers/api_services.dart';
...
class SpeechScreen extends StatefulWidget {
  static const String routeName = '/hakim';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          "Hakim Assistant",
          style: TextStyle(
              fontWeight: FontWeight.w700, fontSize: 25, color: kTextColor),
        ),
      ),
      body: Container(
