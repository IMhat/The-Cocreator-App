...
class Environment {
  //static String ip = Platform.isAndroid ? '192.168.5.122' : 'localhost';
  ...
  static String socketUrl = 'https://inky-torch-trombone.glitch.me';
  static String apiUrl = 'https://inky-torch-trombone.glitch.me/api';
